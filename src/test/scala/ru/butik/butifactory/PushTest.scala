...
class PushTest extends FunSpec{
  ...
  ignore("should push") {
    val pushService = new PushService(Config("", "", "", "", "fcm.googleapis.com", "443", "/fcm/send", "AIzaSyDn-U0alpwS82txxw-z-GIMRusvjEwjZXE"))
...
//    val deviceId = "fs_TplPeunc:APA91bHVpYV7CkmGo8cx4z4cwE-8HYAXUt-NjXecmuov435Nm-RUu0HWk7uyUT0eDNtu7KKKLnnM2QDbJl4nxinRs_lf11w18JXOCR9LMqovRTOC0SoMIZeFtNaBpKrF7J6yzkZZgjjL"
    val artifactVersion = ArtifactVersionAndroid("ru.butik.fitassist", "1.1.1", 8, "http://test.com")
